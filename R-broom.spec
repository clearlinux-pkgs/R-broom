...
Source0  : https://cran.r-project.org/src/contrib/broom_0.7.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624547888
...
/usr/lib64/R/library/broom/tests/testthat/test-rchoice.R
